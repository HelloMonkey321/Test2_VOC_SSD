...
class SSD(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/root/autodl-tmp/ssd-pytorch-master/logs/best_epoch_weights.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font = ImageFont.truetype(font='/root/autodl-tmp/ssd-pytorch-master/model_data/simhei.ttf', size=np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
